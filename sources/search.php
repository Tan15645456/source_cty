<?php  if(!defined('_source')) die("Error");
		...
		$where = " #_product where (type='dichvu' or type='congtrinh')";
		if($key!='')
		{
		...
		$sql = "select ten_$lang,id,photo,tenkhongdau,giaban,giacu,mota_$lang mota from $where $limit";
		$d->query($sql);
		$product = $d->result_array();
		$title_detail = _timthay." ".count($product)." "._ketqua;
