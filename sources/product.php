<?php  if(!defined('_source')) die("Error");
		...
		if($id!=''){ 
			...
			$d->reset();
			$sql_other = "select id,ten_$lang,giaban,giacu,tenkhongdau,photo,mota_$lang as mota from #_product where type='".$type_bar."' and id!='".$row_detail['id']."'";
			...
			$sql="select id,ten_$lang,giaban,giacu,tenkhongdau,photo,mota_$lang as mota from";
			$startpoint = ($page * $per_page) - $per_page;
			$limit = ' limit '.$startpoint.','.$per_page;
